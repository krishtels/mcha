...
from min_squares_method import integral_least_square_method, discrete_least_square_method, integral_LSM, discrete_LSM
import numpy
...
for n in number_of_basic_func:
    ...
    answer_with_collocation_method.append(collocation_method(COEFFS, f, collocation_points))
